...
%\vspace{-.1cm}
%\begin{quote}
%(NR1) \ Fictional texts direct us to imagine certain things.\\[.1cm]
...
% (Q 1.1) \ What are the principles and rules that, in scholarly interpretations, \emph{actually} form the basis for the imaginative construal of fictive worlds?\\
% (Q 1.2) \ How is the imagination of fictive worlds \emph{de facto} related to the appreciation of fictional works in the context of literary studies?
\end{itemize}
\vspace{-.1cm}
