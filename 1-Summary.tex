...
\item[\textbf{(NR1)}] Fictional texts direct us to imagine certain things.
\vspace{-.2cm}
\item[\textbf{(NR2)}] That fictional texts direct us to imagine certain things bears on whether we should aesthetically (dis)value them. 
\end{itemize}
\vspace{-.1cm}
