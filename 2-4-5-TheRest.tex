...
\resizebox{17cm}{!}{
\begin{tabular}{|p{2cm}|p{5cm}|p{5cm}|p{5cm}|p{0cm}}
\hline
&&&&\\
& \centering{\textbf{Subproject 1}} & \centering{\textbf{Subproject 2}} & \centering{\textbf{Subproject 3}} &\\
&&&&\\
\hline
&&&&\\
\centering{\textbf{First Year (2016--17)}} & \centering{\emph{Part 1:} preparation of the `analytic manual' \&  \emph{Part 2:} the paraphrase of a selection from the corpus} & \centering{\emph{Part 1:} the influence of appreciation on what to imagine} & \centering{\emph{Part 1:} imaginative thoughts as intentional actions} &\\
% \textbf{(2016--17)} & Part 2: the paraphrase of selections from the corpus & Part 1: the influence of appreciation on what to imagine & Part 1: imaginative thoughts as intentional actions\\
&&&&\\
\hline
&&&&\\
\centering{\textbf{Second Year (2017--18)}} & \centering{\emph{Part 2:} empirical work on the catalogue of questions} & \centering{\emph{Part 2:} the influence of appreciation on how to imagine} & \centering{\emph{Part 2:} the normativity of imagining in general} &\\
% \textbf{(2017--18)} & Part 2: empirical work on the catalogue of questions & Part 2: the influence of appreciation on how to imagine & Part 2: the normativity of imagining in general\\
&&&&\\
\hline
&&&&\\
\centering{\textbf{Third Year (2018--19)}} & \centering{Writing up the PhD thesis} & \centering{\emph{Part 3:} the implications for prescriptions to imagine} & \centering{\emph{Part 3:} the normativity of imagining in response to fiction} &\\
&&&&\\
% \textbf{(2018--19)} & Writing up the PhD thesis & Part 3: the implications for prescriptions to imagine & Part 3: the normativity of imagining in response to fiction\\
&&&&\\
\hline
&&&&\\
\centering{\textbf{Planned Output}} & \centering{PhD thesis \& one article in a high quality journal} & \centering{6 articles in high quality journals (2 per year)} & \centering{6 articles in high quality journals (2 per year)} &\\
%\textbf{Output} & PhD thesis \& one journal article & 6 journal articles & 6 journal articles\\
&&&&\\
\hline
\end{tabular}}
