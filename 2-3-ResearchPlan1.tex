...
First of all, there are questions in relation to (Q 1.1) and the imaginative construal of the fictional world of `Der Sandmann', which are concerned with \emph{ontological claims:}
...
\noindent Then, there are also questions pertaining to (Q 1.2) and the imagination-based appraisal of Hoffmann's novella, which are about \emph{aesthetic assessments:}
