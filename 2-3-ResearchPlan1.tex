...
\vspace{-.1cm}
\begin{itemize}[leftmargin=2cm]
\item[(i)] Questions concerning \emph{ontological claims:}
\begin{itemize}
\vspace{-.2cm}
...
\vspace{-.1cm}
\begin{itemize}[leftmargin=2cm]
\item[(ii)] Questions concerning \emph{aesthetic appreciation:}
\begin{itemize}
\vspace{-.2cm}
...
\vspace{-.1cm}
\begin{itemize}[leftmargin=2cm]
\item[(iii)] Questions concerning \emph{argumentative justification:}
\begin{itemize}
\vspace{-.2cm}
